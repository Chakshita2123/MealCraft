...
import { Camera, Upload, Plus, ArrowRight, Sparkles, X, Image, Leaf } from 'lucide-react';
    ...
    <div className="scan-page page-enter" id="scan-page">
      ...
      {ingredients.length > 0 && (
        <div className="filters-section glass-card">
          ...
          {/* Find Recipes CTA */}
          <button className="btn-primary btn-lg find-recipes-btn" onClick={handleFindRecipes}>
            Find Recipes
            <ArrowRight size={18} />
          </button>
        </div>
